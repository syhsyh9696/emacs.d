...
(setq cfs--custom-set-fontnames
      '(
        ...
        ("Microsoft Yahei" "华文行楷" "方正姚体" "华文彩云" "华文中宋" "华文仿宋" "黑体" "STXingkai" "微软雅黑" "Noto Sans S Chinese Regular" "Microsoft_Yahei" "Ubuntu Mono" "文泉驿等宽微米黑" "文泉驿等宽正黑" "Hiragino Sans GB" "文泉驿正黑" "文泉驿点阵正黑" "SimHei" "SimSun" "NSimSun" "FangSong" "KaiTi" "FangSong_GB2312" "KaiTi_GB2312" "LiSu" "YouYuan" "新宋体" "宋体" "楷体_GB2312" "仿宋_GB2312" "幼圆" "隶书" "STXihei" "STKaiti" "STSong" "STZhongsong" "STFangsong" "FZShuTi" "FZYaoti" "STCaiyun" "STHupo" "STLiti" "STXinwei" "方正舒体" "方正粗圆_GBK" "华文新魏" "华文细黑")
